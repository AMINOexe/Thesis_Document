...
\begin{figure}
\includegraphics[width=1\linewidth,height=0.7\textheight]{figure/L0_stats_fig} \caption{Layer 0 top 20 Network Importance}\label{fig:unnamed-chunk-7}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth,height=0.85\textheight]{figure/L1_stats_fig} \caption{Layer 1 top 20 Network Importance}\label{fig:unnamed-chunk-8}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth,height=0.6\textheight]{figure/Layer2_stats} \caption{Layer 1 top 20 Network Importance}\label{fig:unnamed-chunk-9}
\end{figure}

\newpage

\begin{figure}
\includegraphics[width=1\linewidth,height=0.43\textheight]{figure/SCL0_hist} \caption{S. Cerevisiae layer statistics}\label{fig:unnamed-chunk-11}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth,height=0.43\textheight]{figure/ATL0_hist} \caption{A. Thaliana layer statistics}\label{fig:unnamed-chunk-12}
\end{figure}
