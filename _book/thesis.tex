...
The following section describes proteins and protein complexes known to be involved in \emph{S. cerevisiae} homotypic vacuole fusion. These components are shown in figures 1,2, and 3 and discussed further in the `fusion stages' section. For readers, it may be helpful to skip to the `fusion stages' section and to use the vacuole fusion components section as a reference while reading.
...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/SC_layer_fig} \caption{S. cerevisiae layers. Layer 0 represents the initial node set. layers 1 and 2 represent the neighbors collected in the the first and second hop. All Layers represents both the initial node set and all neighbors collected from each hop}\label{fig:unnamed-chunk-9}
\end{figure}

\newpage

\begin{figure}
\includegraphics[width=1\linewidth]{figure/AT_layer_fig} \caption{A. thaliana layers. Layer 0 represents the initial node set. layers 1 and 2 represent the neighbors collected in the the first and second hop. All Layers represents both the initial node set and all neighbors collected from each hop}\label{fig:unnamed-chunk-11}
\end{figure}
...
Haas, A., Scheglmann, D., Lazar, T. et al.~The GTPase Ypt7p of Saccharomyces cerevisiae is required on both partner vacuoles for the homotypic fusion step of vacuole inheritance.. EMBO J 14, 5258--5270 (1995). \url{https://doi.org/10.1002/j.1460-2075.1995.tb00210.x}
