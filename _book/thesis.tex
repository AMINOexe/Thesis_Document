...
\begin{figure}
\includegraphics[width=1\linewidth]{figure/SC_subgraph} \caption{S. Cerevisiae subgraph}\label{fig:unnamed-chunk-4}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{figure/AT_subgraph} \caption{A. Thaliana subgraph}\label{fig:unnamed-chunk-5}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.2\linewidth]{figure/Multilayer_network} \caption{Homologous edges between A. Thaliana and S. Cervisiae}\label{fig:unnamed-chunk-7}
\end{figure}
...
For the \emph{A. Thaliana} dataset, layer 0 represented 0.1\% of the total nodes and 0.1\% of the total edges and had an average clustering coefficient of 0.49. For the \emph{S. Cerevisiae} dataset, layer 0 represented 0.6\% of the total nodes and 0.4\% of the total edges. There were a total of 66 homologous edges between layer 0 of the two organisms. These represented 94\% (66/70) of the total edges in the initial \emph{A. Thaliana} layer and 25\% (66/256) of the total edges in the initial \emph{S. Cerevisiae} layer.

\section{Layer 1 Homologs and Properties}\label{layer-1-homologs-and-properties}

For the \emph{A. Thaliana} dataset, layer 1 represented 0.3\% of the total nodes and 1\% of the total edges and had an average clustering coefficient of 0.59. For the \emph{S. Cerevisiae} dataset, layer 1 represented 2\% of the total nodes and 3\% of the total edges. There were a total of 202 homologous edges between layer 1 of the two organisms. These represented 23\% (202/844) of the total edges in layer 1 of the \emph{A. Thaliana} dataset and 15\% (202/1336) of the total edges in layer 1 of the \emph{S. Cerevisiae} dataset.

\section{Layer 2 Homologs and Properties}\label{layer-2-homologs-and-properties}

For the \emph{A. Thaliana} dataset, layer 2 represented 1\% of the total nodes and 6\% of the total edges and had an average clustering coefficient of 0.59. For the \emph{S. Cerevisiae} dataset, layer 2 represented 7\% of the total nodes and 8\% of the total edges. There were a total of 294 homologous edges between layer 2 of the two organisms. These represented 8\% (294/3492) of the total edges in layer 2 of the \emph{A. Thaliana} dataset and 11\% (294/2633) of the total edges in layer 2 of the \emph{S. Cerevisiae} dataset.

\newpage

\begin{figure}
\includegraphics[width=1\linewidth,height=0.43\textheight]{figure/SC_layer_stats} \caption{S. Cerevisiae layer statistics}\label{fig:unnamed-chunk-9}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth,height=0.43\textheight]{figure/AT_layer_stats} \caption{A. Thaliana layer statistics}\label{fig:unnamed-chunk-10}
\end{figure}
