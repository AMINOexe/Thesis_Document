...
```{r, echo=FALSE, fig.cap="S. cerevisiase layers. Layer 0 represents the initial node set. layers 1 and 2 represent the neighbors collected in the the first and second hop. All Layers represents both the initial node set and all neighbors collected from each hop",out.width="100%"}
